...
class InvoiceController extends Controller
{
    ...
    public function submitInvoice(InvoiceRequest $request)
    {
        ...
        $signed = $this->signInvoiceJson($invoiceData);
        if (!$signed) {
        ...
        $LatestjsonDocument = json_encode($signed, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
    ...
    private function signInvoiceJson(array $invoiceData): array
    {
        ...
        $pfx = file_get_contents(storage_path('certs/signing.pfx'));
