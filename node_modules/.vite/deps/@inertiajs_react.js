...
var Pe = async (r) => {
  ...
  let e = Se(), t = await Ee(), i = await Ke(t);
  if (!i) throw new Error("Unable to encrypt history");
  return await Me(e, i, r);
};
...
var Se = () => {
  ...
  return u.set(q.iv, Array.from(e)), e;
};
...
var Be = async (r) => {
  ...
  u.set(q.key, Array.from(new Uint8Array(e)));
};
var Ke = async (r) => {
  if (r) return r;
  let e = await Ge();
...
function N(r) {
  return r instanceof File || r instanceof Blob || r instanceof FileList && r.length > 0 || r instanceof FormData && Array.from(r.values()).some((e) => N(e)) || typeof r == "object" && r !== null && Object.values(r).some((e) => N(e));
}
...
var Ce = (r, e, t, i, n) => {
  ...
  if ((N(e) || i) && !Y(e) && (e = Z(e)), Y(e)) return [a, e];
  let [c, d] = qe(t, a, e, n);
  return [y(c), d];
};
function qe(r, e, t, i = "brackets") {
  ...
  return r === "get" && Object.keys(t).length && (h.search = M.stringify((0, import_deepmerge.default)(M.parse(h.search, { ignoreQueryPrefix: true }), t), { encodeValuesOnly: true, arrayFormat: i }), t = {}), [[n ? `${h.protocol}//${h.host}` : "", a ? h.pathname : "", c ? h.pathname.substring(1) : "", d ? h.search : "", m ? h.hash : ""].join(""), t];
}
function I(r) {
...
var re = class {
  ...
  restore(e) {
    var _a, _b;
    if (!$) return (_b = (_a = this.initialState) == null ? void 0 : _a[this.rememberedState]) == null ? void 0 : _b[e];
  }
  pushState(e, t = null) {
    if (!$) {
      if (this.preserveUrl) {
      ...
      this.current = e, U.add(() => this.getPageData(e).then((i) => {
        window.history.pushState({ page: i }, "", e.url), t && t();
      }));
    }
  }
  getPageData(e) {
  ...
  decrypt(e = null) {
    var _a;
    if ($) return Promise.resolve(e ?? s.get());
    ...
    if (o.isValidState(t)) {
      o.decrypt(t.page).then((i) => {
        s.setQuietly(i, { preserveState: false }).then(() => {
          g.restore(o.getScrollRegions()), g.restoreDocument(), R(s.get());
        });
      }).catch(() => {
...
var G = class {
  ...
  static handleDefault() {
    typeof window < "u" && s.setUrlHash(window.location.hash), s.set(s.get(), { preserveState: true }).then(() => {
      R(s.get());
    });
  }
};
...
var le = (r) => {
  ...
  for (let [e, t] of Object.entries(Xe)) if (r.endsWith(e)) return parseFloat(r) * t;
  return parseInt(r);
};
var ce = class {
  constructor() {
...
var Ae = { modal: null, listener: null, show(r) {
...
var K = class {
  ...
  poll(e, t = {}, i = {}) {
    return Te.add(e, () => this.reload(t), { autoStart: i.autoStart ?? true, keepAlive: i.keepAlive ?? false });
  }
  visit(e, t = {}) {
...
var C = null;
var ze = (r) => {
  Object.assign(f, r), f.includeCSS && rt(f.color);
};
var J = (r) => {
  let e = Ie();
  r = De(r, f.minimum, 1), C = r === 1 ? null : r;
  let t = Ye(!e), i = t.querySelector(f.barSelector), n = f.speed, a = f.easing;
  t.offsetWidth, tt((c) => {
...
var _e = (r) => {
  !r && !C || (ke(0.3 + 0.5 * Math.random()), J(1));
};
var ke = (r) => {
  let e = C;
  if (e === null) return Le();
...
var Ye = (r) => {
  var _a;
  if (Ze()) return document.getElementById(p);
  document.documentElement.classList.add(`${p}-busy`);
  let e = document.createElement("div");
  e.id = p, e.innerHTML = f.template;
  let t = e.querySelector(f.barSelector), i = r ? "-100" : X(C || 0), n = Oe();
...
var Oe = () => et(f.parent) ? f.parent : document.querySelector(f.parent);
var Ue = () => {
  var _a;
...
var Ze = () => document.getElementById(p) !== null;
var et = (r) => typeof HTMLElement == "object" ? r instanceof HTMLElement : r && typeof r == "object" && r.nodeType === 1 && typeof r.nodeName == "string";
function De(r, e, t) {
...
var b = { configure: ze, isStarted: Ie, done: _e, set: J, remove: Ue, start: Le, status: C, show: it, hide: nt };
var Q = 0;
var j = (r = false) => {
...
function st(r) {
  document.addEventListener("inertia:start", (e) => ot(e, r)), document.addEventListener("inertia:progress", at);
}
function ot(r, e) {
...
function He({ delay: r = 250, color: e = "#29d", includeCSS: t = true, showSpinner: i = false } = {}) {
...
function W2({ children: u2, initialPage: o2, initialComponent: n, resolveComponent: s2, titleCallback: a, onHeadUpdate: m }) {
  let [p2, g2] = (0, import_react2.useState)({ component: n || null, page: o2, key: null }), P2 = (0, import_react2.useMemo)(() => Fe(typeof window > "u", a || ((l) => l), m || (() => {
  })), []);
  if ((0, import_react2.useEffect)(() => {
    jr.init({ initialPage: o2, resolveComponent: s2, swapComponent: async ({ component: l, page: e, preserveState: f2 }) => {
      g2((t) => ({ component: l, page: e, key: f2 ? t.key : Date.now() }));
    } }), jr.on("navigate", () => P2.forceUpdate());
...
async function ae2({ id: u2 = "app", resolve: o2, setup: n, title: s2, progress: a = {}, page: m, render: p2 }) {
  let g2 = typeof window > "u", P2 = g2 ? null : document.getElementById(u2), y2 = m || JSON.parse(P2.dataset.page), l = (t) => Promise.resolve(o2(t)).then((h) => h.default || h), e = [], f2 = await Promise.all([l(y2.component), jr.decryptHistory().catch(() => {
...
var le2 = (0, import_react8.forwardRef)(({ children: u2, as: o2 = "a", data: n = {}, href: s2, method: a = "get", preserveScroll: m = false, preserveState: p2 = null, replace: g2 = false, only: P2 = [], except: y2 = [], headers: l = {}, queryStringArrayFormat: e = "brackets", async: f2 = false, onClick: t = k2, onCancelToken: h = k2, onBefore: T2 = k2, onStart: x2 = k2, onProgress: I2 = k2, onFinish: q2 = k2, onCancel: N2 = k2, onSuccess: J2 = k2, onError: O2 = k2, prefetch: F2 = false, cacheFor: b2 = 0, ...Q2 }, Y2) => {
  ...
  let j2 = { onClick: (c) => {
    t(c), Ne(c) && (c.preventDefault(), jr.visit(s2, $2));
  } }, i = { onMouseEnter: () => {
    ...
    Ne(c) && (c.preventDefault(), w2());
  }, onMouseUp: (c) => {
    c.preventDefault(), jr.visit(s2, $2);
  }, onClick: (c) => {
    t(c), Ne(c) && c.preventDefault();
  } };
...
function me2(u2, o2) {
  ...
  let b2 = (0, import_react9.useCallback)((i, S, r = {}) => {
    let c = { ...r, onCancelToken: (d) => {
      ...
      if (N2(false), O2(false), clearTimeout(g2.current), r.onBefore) return r.onBefore(d);
    }, onStart: (d) => {
    ...
    i === "delete" ? jr.delete(S, { ...c, data: F2.current(P2) }) : jr[i](S, F2.current(P2), c);
...
function ge2(u2, o2 = {}, n = { keepAlive: false, autoStart: true }) {
  let s2 = (0, import_react11.useRef)(jr.poll(u2, o2, { ...n, autoStart: false }));
...
function Pe2(u2 = {}) {
  let o2 = typeof window > "u" ? null : jr.getCached(window.location.pathname, u2), n = typeof window > "u" ? null : jr.getPrefetching(window.location.pathname, u2), [s2, a] = (0, import_react12.useState)((o2 == null ? void 0 : o2.staleTimestamp) || null), [m, p2] = (0, import_react12.useState)(n !== null), [g2, P2] = (0, import_react12.useState)(o2 !== null);
  return (0, import_react12.useEffect)(() => {
    let y2 = jr.on("prefetching", (e) => {
  ...
  }, []), { lastUpdatedAt: s2, isPrefetching: m, isPrefetched: g2, flush: () => jr.flush(window.location.pathname, u2) };
}
